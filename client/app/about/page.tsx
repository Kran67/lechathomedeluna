    ...
    return (
        <main className="flex flex-col gap-20 w-full md:pt-20 md:px-140 items-center">
            ...
            <div className="flex flex-col gap-10 w-full max-w-[900px] px-16 md:px-0 text-xl text-(--primary) relative">
                ...
                <div className="text-[24px] md:text-[32px] font-bold text-(--primary)">Luna, tu es rentrée dans ma vie et tu as tout changé.</div><br />
                ...
                <i className="hidden md:block absolute fa fa-paw -rotate-25 !text-[80px] text-(--primary) left-200 opacity-50"></i>
                <i className="hidden md:block absolute fa fa-paw rotate-30 !text-[50px] text-(--primary) right-10 opacity-50 top-300"></i>
                <i className="hidden md:block absolute fa fa-paw -rotate-15 !text-[40px] text-(--primary) -left-40 opacity-50 top-450"></i>
                <i className="hidden md:block absolute fa fa-paw rotate-15 !text-[40px] text-(--primary) right-0 opacity-50 top-800"></i>
                <i className="hidden md:block absolute fa fa-paw -rotate-35 !text-[40px] text-(--primary) opacity-50 left-250 top-1150"></i>
                <i className="hidden md:block absolute fa fa-paw rotate-45 !text-[40px] text-(--primary) right-0 opacity-50 top-1150"></i>
                <Image src="/images/luna.png" alt="Luna" width={114} height={145} className="hidden sm:block absolute sm:right-60 lg:right-50 sm:top-1120 lg:top-400" />
            </div>
            <Footer />
        </main>
    );
