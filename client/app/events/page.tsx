...
export const metadata: Metadata = {
    title: "Le Chat'Home de Luna - Evénements",
    description: "Evénements - Le Chat'Home de Luna"
};

/**
 * Affiche la page Events
 * 
 * @function EventsPage
 */
export default function EventsPage() {
    return (
        <main className="flex flex-col gap-20 w-full items-center md:pt-20 md:px-140">
            <Header activeMenu={HeaderMenuItems.Events} />
            <div className="flex flex-col gap-51 md:gap-20 px-16 md:p-0 w-full xl:w-1115">
                <span className="text-[32px] text-(--primary) w-full">Page des événements</span>
            </div>
            <Footer />
        </main>
    );
